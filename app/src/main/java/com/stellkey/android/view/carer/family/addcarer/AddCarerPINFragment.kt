...
import com.stellkey.android.databinding.FragmentAddCarerPINBinding
...
class AddCarerPINFragment : BaseFragment() {

    private val binding by viewBinding<FragmentAddCarerPINBinding>()
    ...
    companion object {
        @JvmStatic
        fun newInstance() = AddCarerPINFragment()
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_add_carer_p_i_n, container, false)
    }
    ...
    private val onClickCallback = View.OnClickListener { view ->
        when (view) {
            ...
            binding.btnNext -> {
                ...
                addFragment(AddCarerConfirmPINFragment.newInstance())
            }
            binding.tvCancel -> {
                initCancelDialog()
            }
