...
import com.stellkey.android.databinding.FragmentOnboardingSwitchInterfaceBinding
...
class OnBoardingSwitchInterfaceFragment : BaseFragment() {

    private val binding by viewBinding<FragmentOnboardingSwitchInterfaceBinding>()

    private lateinit var taskStarAdapter: TaskStarAdapter

    companion object {
        @JvmStatic
        fun newInstance() = OnBoardingSwitchInterfaceFragment()
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_onboarding_switch_interface, container, false)
    }
    ...
    private val onClickCallback = View.OnClickListener { view ->
        when (view) {
            binding.ivOnBoardingBackground -> {
                addFragment(OnBoardingKidHomeFragment.newInstance())
            }
        }
    }
}