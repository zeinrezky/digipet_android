...
import com.stellkey.android.databinding.FragmentEditPINInputNewBinding
...
class EditPINInputNewFragment : BaseFragment() {

    private lateinit var dataBinding: FragmentEditPINInputNewBinding

    //private val binding by viewBinding<FragmentEditPINInputNewBinding>()
    ...
    companion object {
        @JvmStatic
        fun newInstance() = EditPINInputNewFragment()
    ...
    override fun onCreateView(
        ...
        dataBinding =
            DataBindingUtil.inflate(
                inflater,
                R.layout.fragment_edit_p_i_n_input_new,
                container,
                false
            )
        ...
        dataBinding.apply {
            when (AppPreference.getProfileType()) {
                Constant.FamilyType.CARERS -> {
                    tvTitle.textOrNull =
                        requireContext().resources.getString(R.string.edit_carer_new_pin_title)
                }
                Constant.FamilyType.KIDS -> {
                    tvTitle.textOrNull =
                        requireContext().resources.getString(R.string.edit_kid_new_pin_title)
                }
            }
        }
    }
        ...
        when (view) {
            ...
            dataBinding.btnNext -> {
                dataBinding.apply {
                    when (AppPreference.getProfileType()) {
                        Constant.FamilyType.CARERS -> {
                            AppPreference.putTempCarerPIN(tempProfilePIN)
                            addFragment(EditPINConfirmFragment.newInstance())
                            EditPINConfirmFragment.isFromEditProfile = isFromEditProfile
                        }
                        Constant.FamilyType.KIDS -> {
