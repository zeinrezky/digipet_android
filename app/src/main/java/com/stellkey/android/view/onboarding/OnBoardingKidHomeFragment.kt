...
import com.stellkey.android.databinding.FragmentOnboardingKidHomeBinding
...
class OnBoardingKidHomeFragment : BaseFragment() {

    private val binding by viewBinding<FragmentOnboardingKidHomeBinding>()

    companion object {
        @JvmStatic
        fun newInstance() = OnBoardingKidHomeFragment()
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_onboarding_kid_home, container, false)
    }
    ...
    private val onClickCallback = View.OnClickListener { view ->
        when (view) {
            binding.ivOnBoardingBackground -> {
                addFragment(OnBoardingKidTaskFragment.newInstance())
            }
        }
    }
}