...
import com.stellkey.android.databinding.FragmentRegisterConfirmProfilePINBinding
...
import kotlinx.android.synthetic.main.fragment_register_confirm_profile_p_i_n.*

class RegisterConfirmProfilePINFragment : BaseFragment() {

    private val binding by viewBinding<FragmentRegisterConfirmProfilePINBinding>()
    private var tempProfilePIN = emptyString

    companion object {
        @JvmStatic
        fun newInstance() = RegisterConfirmProfilePINFragment()
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_register_confirm_profile_p_i_n, container, false)
    }
    ...
    private fun validateForm() {
        if (AppPreference.getTempChildProfilePIN() == tempProfilePIN) {
            ...
            addFragment(RegisterChildAgeFragment.newInstance())
        }
