...
import com.stellkey.android.databinding.FragmentOnboardingFamilyTaskBinding
...
class OnBoardingFamilyTaskFragment : BaseFragment() {
    private val binding by viewBinding<FragmentOnboardingFamilyTaskBinding>()

    private lateinit var taskStarAdapter: TaskStarAdapter

    companion object {
        @JvmStatic
        fun newInstance() = OnBoardingFamilyTaskFragment()
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_onboarding_family_task, container, false)
    }
    ...
    private val onClickCallback = View.OnClickListener { view ->
        when (view) {
            binding.ivOnBoardingBackground -> {
                addFragment(OnBoardingAddTaskFragment.newInstance())
            }
        }
    }
