...
import com.stellkey.android.databinding.FragmentAddKidPINBinding
...
class AddKidPINFragment : BaseFragment() {

    private val binding by viewBinding<FragmentAddKidPINBinding>()
    ...
    companion object {
        @JvmStatic
        fun newInstance() = AddKidPINFragment()
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_add_kid_p_i_n, container, false)
    }
    ...
    private val onClickCallback = View.OnClickListener { view ->
        when (view) {
            ...
            binding.btnSave -> {
                ...
                addFragment(AddKidConfirmPINFragment.newInstance())
            }
            binding.tvCancel -> {
                initCancelDialog()
            }
