...
import com.stellkey.android.databinding.FragmentOnboardingChooseTaskBinding
...
class OnBoardingChooseTaskFragment : BaseFragment() {
    private val binding by viewBinding<FragmentOnboardingChooseTaskBinding>()

    companion object {
        @JvmStatic
        fun newInstance() = OnBoardingChooseTaskFragment()
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_onboarding_choose_task, container, false)
    }
    ...
    private val onClickCallback = View.OnClickListener { view ->
        when (view) {
            binding.ivOnBoardingBackground -> {
                addFragment(OnBoardingSwitchInterfaceFragment.newInstance())
            }
        }
    }
