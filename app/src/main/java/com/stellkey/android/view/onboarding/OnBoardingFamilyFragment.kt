...
import com.stellkey.android.databinding.FragmentOnBoardingFamilyBinding
...
class OnBoardingFamilyFragment : BaseFragment() {

    private val binding by viewBinding<FragmentOnBoardingFamilyBinding>()

    private lateinit var taskStarAdapter: TaskStarAdapter

    companion object {
        @JvmStatic
        fun newInstance() = OnBoardingFamilyFragment()
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_on_boarding_family, container, false)
    }
    ...
    private val onClickCallback = View.OnClickListener { view ->
        when (view) {
            binding.ivOnBoardingBackground -> {
                addFragment(OnBoardingFamilyTaskFragment.newInstance())
            }
        }
    }
}