...
import com.stellkey.android.databinding.FragmentOnboardingCompletedTaskBinding
...
class OnBoardingCompletedTaskFragment : BaseFragment() {

    private val binding by viewBinding<FragmentOnboardingCompletedTaskBinding>()

    private lateinit var taskStarAdapter: TaskStarAdapter

    companion object {
        @JvmStatic
        fun newInstance() = OnBoardingCompletedTaskFragment()
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_onboarding_completed_task, container, false)
    }
    ...
    private val onClickCallback = View.OnClickListener { view ->
        when (view) {
            binding.ivOnBoardingBackground -> {
                addFragment(OnBoardingTaskActionFragment.newInstance())
            }
        }
    }
